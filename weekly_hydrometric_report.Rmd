...
definitions <- data.frame(
  ...
  Definition = c("WSC station number with a link to the WSC station website.", 
                 ...
                 "The average value of today's (or most recent date captured) measurements. Green symbology ndicates the value is between Q25-Q75. Red indicates the value is out of this range.",
                 ...
                 "Mean Annual Discharge, a measure of the average amount of water flow through a river or stream over the course of a year.",
                 ...
                 "The years during which the data was collected and used for analysis.",
